...
then
    echo "Enter Entity file name:"
    read schema_file_name

    schema_file="$dir/src/entities/$schema_file_name.entity.ts"

    echo "Enter Entity class name:"
    read schema_name
    ...
    then
        ...
        echo "${schema_name} Entity created successfully"
    else
        echo "Entity '${schema_name}' already exists!"
    fi
